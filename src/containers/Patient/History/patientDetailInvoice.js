...
import './patientDetailInvoice.scss'
...
class detailInvoice extends Component {
    ...
    render() {
        let { detail_invoice, invoiceId, patientId, doctorId, patientName, doctorName, doctor_price, bookingId, price, status, note, createAt } = this.state;
        return (
            <>
                <HomeHeader />
                <div className='patient-detail_invoice-container'>
